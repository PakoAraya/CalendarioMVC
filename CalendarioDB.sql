...
/****************************************************************
SCRIPT EJERCICIO FINAL | MODULO 5
...
Script de base de datos para proyecto de web dinamico
desarrollado con postgresql en su version 16.4 y java web
con arquitectura MVC, principios SOLID y Patron DAO.
La base de datos solo cuenta con 2 tablas que serian 
horoscopo que almacena informacion de fechas y tipo animal
y usuarios que almacena informacion de los usuarios de la App
****************************************************************/
/****************************************************************
...
CREATE TABLE horoscopo (
    ...
    animal VARCHAR(30), -- NOT NULL UNIQUE, -- Nombre del animal único
    fecha_inicio DATE, -- NOT NULL,
    fecha_fin DATE -- NOT NULL
);

-- Insertar datos de ejemplo en horoscopo
INSERT INTO horoscopo (animal, fecha_inicio, fecha_fin) VALUES
('Rata', '1924-05-02', '1925-01-24'),
...
CREATE TABLE usuarios (
    id SERIAL PRIMARY KEY,  -- Llave primaria automática
    nombre VARCHAR(30), -- NOT NULL,
    username VARCHAR(30), -- UNIQUE NOT NULL,
    email VARCHAR(30), -- UNIQUE NOT NULL,
    fecha_nacimiento DATE, -- NOT NULL,
    password VARCHAR(30), -- NOT NULL,
    horoscopo_id INT REFERENCES horoscopo(id) -- Foreign key hacia horoscopo
);
